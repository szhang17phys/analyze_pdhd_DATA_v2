...
//  const char* directory = "/pnfs/dune/scratch/users/szh2/pdhd_DATA_Michel/beamRun_28867_DECON/michelt0_2k_rest/";  
      ...
      for (size_t ci = 0; ci < candidateIndicesForEvent.size(); ci++) {
        ...
        for (size_t i = 0; i < pandorat0->size(); ++i) {
          if ((*trkid)[i] == candTrack) {
            ...
            TString outputFileName = Form("/exp/dune/data/users/szh2/running_results/PDHD_keepupData_list/beamRun_28867/event_wvf_extract/decon_3000Files_window_Ndot12_Pdot03/1000Files/extracted_files/extractDecon_event%d_trackID%d.root", event, (*trkid)[i]);
//            TString outputFileName = Form("/exp/dune/data/users/szh2/running_results/PDHD_keepupData_list/beamRun_28867/event_wvf_extract/decon_3000Files_window_Ndot12_Pdot03/2000Files_rest/extracted_files/extractDecon_event%d_trackID%d.root", event, (*trkid)[i]);
