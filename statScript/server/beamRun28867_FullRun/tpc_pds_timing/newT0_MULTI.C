{
  ...
  anatree->Add("/pnfs/dune/scratch/users/szh2/pdhd_DATA_Michel/beamRun_28867_DECON/michelt0_1k/*.root");
  anatree->Add("/pnfs/dune/scratch/users/szh2/pdhd_DATA_Michel/beamRun_28867_DECON/michelt0_2k_rest/*.root");
  ...
  TFile file("TPC_PDS_Matching_RawFiles.root", "RECREATE");
