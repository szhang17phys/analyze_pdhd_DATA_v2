...
# Input file
input_file = "./original_list/initial_print.txt"
...
with open(decay_x_file, "w") as dx, open(decay_y_file, "w") as dy, open(decay_z_file, "w") as dz, open(michel_score_file, "w") as ms, open(michel_hits_file, "w") as mh:
