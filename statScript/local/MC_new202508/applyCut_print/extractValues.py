...
# Input file
input_file = "./print_filtered_New20250804.txt"

# Output files
decay_x_file = "./filtered_results/decayX_filtered.txt"
decay_y_file = "./filtered_results/decayY_filtered.txt"
decay_z_file = "./filtered_results/decayZ_filtered.txt"  # end point of track
michel_score_file = "./filtered_results/michelScore_filtered.txt"
michel_hits_file = "./filtered_results/michelHits_filtered.txt"
start_x_file = "./filtered_results/startX_filtered.txt"   # start point of track
start_y_file = "./filtered_results/startY_filtered.txt"
start_z_file = "./filtered_results/startZ_filtered.txt"

eventID_file = "./filtered_results/eventID_filtered.txt"
trackID_file = "./filtered_results/trackID_filtered.txt"

opchs_file_path = "./filtered_results/opchs_filtered.txt"
