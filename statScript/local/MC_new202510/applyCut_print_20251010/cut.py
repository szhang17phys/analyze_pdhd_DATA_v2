...
def extract_michel_blocks(input_file, output_file):
    ...
    def selection_ok(score, hits, end_x, end_y, end_z):
        return (
            ...
            (score > 0.2 and hits > 2 and #loosen TPC cuts---
             -356 < end_x < 356 and
             30 < end_y < 580 and
             30 < end_z < 435)
        )
...
extract_michel_blocks(
    "/Users/shuaixiangzhang/Work/current/FNAL_Work2024/michel_e/t0_tagging/pdhd_DATA_v2/analyze_pdhd_DATA_v2/statScript/server/MC_new202510/michelt0_process_original/print_New20251010_initial.txt",
    "./filtered_New20251010_print.txt"
)
