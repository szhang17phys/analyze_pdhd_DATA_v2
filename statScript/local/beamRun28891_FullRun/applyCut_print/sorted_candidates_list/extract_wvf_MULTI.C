{
  ...
  std::vector<std::string> partDirs = {
    "part1", "part3", "part4", "part5", "part6"
  };

  std::string baseDir = "/pnfs/dune/scratch/users/szh2/pdhd_DATA_Michel/beamRun_28891_DECON/";
...
//            TString outputFileName = Form("/exp/dune/data/users/szh2/running_results/PDHD_keepupData_list/beamRun_28867/event_wvf_extract/decon_3000Files_window_Ndot12_Pdot03/1000Files/extracted_files/extractDecon_event%d_trackID%d.root", event, (*trkid)[i]);
            TString outputFileName = Form("/exp/dune/data/users/szh2/running_results/PDHD_keepupData_list/beamRun_28867/event_wvf_extract/decon_3kFiles_Ndot10_Pdot02/extracted_files/extractDecon_event%d_trackID%d.root", event, (*trkid)[i]);
