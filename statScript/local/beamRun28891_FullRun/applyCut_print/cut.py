...
#        michel_block_pattern = re.compile(r"======Michel e CAND! \(score>0.1\) COUNT (DECON)======")
...
# Usage
extract_michel_blocks("/Users/shuaixiangzhang/Work/current/FNAL_Work2024/michel_e/t0_tagging/pdhd_DATA_v2/analyze_pdhd_DATA_v2/statScript/server/beamRun28891_FullRun/michelt0_process_original/fullRun_initial_processing.txt", "./filtered_fullRun_print.txt")
