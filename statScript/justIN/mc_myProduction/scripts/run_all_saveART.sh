...
mv cosmic_reco_${logical_jobid}_eventID${FIRSTEVENT}_${timestamp}.root cosmic_reco_run${RUN_ID}_job${logical_jobid}_eventID${FIRSTEVENT}_${timestamp}.root
ifdh cp -D cosmic_reco_run${RUN_ID}_job${logical_jobid}_eventID${FIRSTEVENT}_${timestamp}.root /pnfs/dune/scratch/users/szh2/MC_pdhd_Michel/new_mcTruth/
...
rm -f cosmic_reco_run${RUN_ID}_job${logical_jobid}_eventID${FIRSTEVENT}_${timestamp}.root
