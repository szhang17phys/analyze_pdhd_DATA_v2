...
//  anatree->Add("/Users/shuaixiangzhang/Work/current/FNAL_Work2024/michel_e/t0_tagging/pdhd_DATA_v2/t0_rootFiles/viktor_decon_test/michelt0_Decon_run028867_0382_dataflow1.root");
  anatree->Add("/Users/shuaixiangzhang/Work/current/FNAL_Work2024/michel_e/t0_tagging/pdhd_DATA_v2/t0_rootFiles/viktor_decon_test/new_filter/michelt0_new_run028867_0103_dataflow0.root");
  ...
  for(int iEntry = 0; anatree->LoadTree(iEntry) >=0; ++iEntry){
    ...
    for(size_t i = 0; i<pandorat0->size(); ++i){
      ...
      if ((*michelscore)[i]>0.935 && (*endx)[i]<292 && (*endx)[i]>291){
