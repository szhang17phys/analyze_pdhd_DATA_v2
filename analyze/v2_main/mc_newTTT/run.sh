...
base_root="/exp/dune/data/users/szh2/running_results/MC_PDHD_list/server_processing/t0_rootFiles"
...
# Input files
mcTruth_file="/exp/dune/data/users/szh2/running_results/MC_PDHD_list/server_processing/202510/statScript_local/add_mcTruth_npMichel/updated_New${DATE}_initial.txt"
