...
void processSingleFile(const char* inputFileName, const double thre_summed) {  
    ...
    std::ofstream muonFile("muon_total_20251010.txt", std::ios::app);
    std::ofstream michelFile("michel_total_20251010.txt", std::ios::app);
    std::ofstream thirdFile("third_total_20251010.txt", std::ios::app);
...
void intensity_thre() {
    ...
    std::ofstream clear1("muon_total_20251010.txt");
    std::ofstream clear2("michel_total_20251010.txt");
    std::ofstream clear3("third_total_20251010.txt");  // NEW
    clear1.close();
    clear2.close();   
    clear3.close();

    const char* inputDirectory = "/Users/shuaixiangzhang/Work/current/FNAL_Work2024/michel_e/t0_tagging/pdhd_DATA_v2/t0_rootFiles/new202510_MC/wvf_merged_applyCut_20251010";
