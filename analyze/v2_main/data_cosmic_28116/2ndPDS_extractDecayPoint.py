...
x_path = "posX_extract_3ndPDS.txt"
y_path = "posY_extract_3ndPDS.txt"
z_path = "posZ_extract_3ndPDS.txt"
...
with open(x_path, "w") as x_out, open(y_path, "w") as y_out, open(z_path, "w") as z_out:
    ...
    with open("./peakFinder_muonTime_new20250602.txt", "r") as f:
        for line in f:

            # Only process lines that contain "_2.root"
            if "_3.root" not in line:
                continue
