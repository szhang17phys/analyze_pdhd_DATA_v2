...
x_path = "posX_extract_20250917.txt"
y_path = "posY_extract_20250917.txt"
z_path = "posZ_extract_20250917.txt"
E_path = "energy_extract_20250917.txt"
L_path = "lifetime_extract_20250917.txt"
P_path = "pdg_extract_20250917.txt"   # <-- fixed: separate PDG output
...
with open(x_path, "w") as x_out, open(y_path, "w") as y_out, open(z_path, "w") as z_out, \
    ...
    #================================================================
    # Process each line in muon_total_20250917.txt
    #================================================================
    with open("./muon_total_20250917.txt", "r") as f:
        for line in f:
