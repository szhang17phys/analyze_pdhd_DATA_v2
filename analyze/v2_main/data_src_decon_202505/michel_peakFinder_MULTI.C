...
void michel_peakFinder_MULTI() {
    // Clear output files before starting (20250529): Necessary!!!
    std::ofstream clear1("peakFinder_muonTime.txt");
    std::ofstream clear2("peakFinder_michelTime.txt");
    std::ofstream clear3("peakFinder_michelCoincidence.txt");
    clear1.close();
    clear2.close();
    clear3.close();
