...
x_path = "posX_extract_20251019.txt"
y_path = "posY_extract_20251019.txt"
z_path = "posZ_extract_20251019.txt"
E_path = "energy_extract_20251019.txt"
L_path = "lifetime_extract_20251019.txt"
P_path = "pdg_extract_20251019.txt"   # <-- fixed: separate PDG output
S_path = "michelScore_extract_20251019.txt"
H_path = "michelHits_extract_20251019.txt"
...
with open(x_path, "w") as x_out, open(y_path, "w") as y_out, open(z_path, "w") as z_out, \
    ...
    #================================================================
    with open("/Users/shuaixiangzhang/Work/current/FNAL_Work2024/michel_e/t0_tagging/pdhd_DATA_v2/analyze_pdhd_DATA_v2/statScript/local/MC_new202510/add_mcTruth_npMichel/updated_New20251019_initial.txt", "r") as f:
        filtered_lines = f.readlines()

    #================================================================
    # Process each line in muon_total_20251019.txt
    #================================================================
    with open("./muon_total_20251019.txt", "r") as f:
        for line in f:
