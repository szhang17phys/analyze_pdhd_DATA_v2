...
void intensity_thre_exe5_tmp() {
    ...
    const std::string inputDirectory = "/Users/shuaixiangzhang/Work/current/FNAL_Work2024/michel_e/t0_tagging/pdhd_DATA_v2/t0_rootFiles/new202510_MC/wvf_merged_applyCut_" + DATE;
...
// New main function--------
// ----------------------------------------------------------------------
void intensity_thre_exe5(const char* dateArg = "00000000") {
    DATE = dateArg;              // override global variable
    intensity_thre_exe5_tmp();       // call your existing function
}
