...
void processSingleFile(const char* inputFileName, const double thre_summed) {  
    ...
    std::ofstream muonFile("muon_time_20250920.txt", std::ios::app);
    std::ofstream michelFile("michel_time_20250920.txt", std::ios::app);
    std::ofstream muonFile_2("muon_intensity_20250920.txt", std::ios::app);
    std::ofstream michelFile_2("michel_intensity_20250920.txt", std::ios::app);    
...
void intensity_thre() {
    ...
    std::ofstream clear1("muon_time_20250920.txt");
    std::ofstream clear2("michel_time_20250920.txt");
    std::ofstream clear3("muon_intensity_20250920.txt");
    std::ofstream clear4("michel_intensity_20250920.txt");    
    clear1.close();
    clear2.close();
    clear3.close();
    clear4.close();    

    const char* inputDirectory = "/Users/shuaixiangzhang/Work/current/FNAL_Work2024/michel_e/t0_tagging/pdhd_DATA_v2/t0_rootFiles/data_3k_new20250604/decon_wvf_coincidence_applyCut";
