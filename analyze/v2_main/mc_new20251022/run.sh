...
DATE="20251022"          # <-- change this for each dataset
runID="22"
# ---------------------------------------------------------

# Base directory for your dataset
base_root="/Users/shuaixiangzhang/Work/current/FNAL_Work2024/michel_e/t0_tagging/pdhd_DATA_v2/t0_rootFiles/new202510_MC"
...
# Log files
log_exe1="print_wvfCoin_merged.log"
log_exe2="print_wvfCoin_count.log"
log_exe3="print_trueInfo.log"
log_exe4="print_applyCut.log"
# --------------------------------------------------------
...
# Input files
mcTruth_file="/Users/shuaixiangzhang/Work/current/FNAL_Work2024/michel_e/t0_tagging/pdhd_DATA_v2/analyze_pdhd_DATA_v2/statScript/local/MC_new202510/add_mcTruth_npMichel/updated_New${DATE}_initial.txt"
...
log_exe5="./print_intensity_thre.log"
...
# --- Run ROOT macro and pass DATE to wrapper ---
root -l -b -q "./intensity_thre_exe5.C(\"${DATE}\")" > "${log_exe5}" 2>&1
...
# Run the Python script with DATE passed as environment variable
DATE="${DATE}" python3 final_true_info_exe6.py > "${log_exe6}" 2>&1
