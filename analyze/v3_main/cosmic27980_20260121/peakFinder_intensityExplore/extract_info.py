...
x_path = "posX_extract_20260121.txt"
y_path = "posY_extract_20260121.txt"
z_path = "posZ_extract_20260121.txt"
S_path = "michelScore_extract_20260121.txt"
H_path = "michelHits_extract_20260121.txt"
...
with open(x_path, "w") as x_out, open(y_path, "w") as y_out, open(z_path, "w") as z_out, \
    ...
    #================================================================
    with open("/Volumes/ssd_zhang/thesis_michel/server_processing/statScript_local/applyCut_print/cosmic27980/filtered_cosmic27980_print.txt", "r") as f:
        filtered_lines = f.readlines()

    #================================================================
    # Process each line in muon_total_20260121.txt
    #================================================================
    with open("./muon_total_20260121.txt", "r") as f:
        for line in f:
