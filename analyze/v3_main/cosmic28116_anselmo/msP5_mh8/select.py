...
dest_dir = "/Users/shuaixiangzhang/Work/current/FNAL_Work2024/michel_e/t0_tagging/pdhd_DATA_v2/t0_rootFiles/cosmic_28116/applyCut_MSp5MH8_anselmo"
...
for fname in os.listdir(src_dir):
    ...
    if entry is not None:
        ...
        #==============================================
        if score > 0.6 and hits > 8:
            shutil.copy2(os.path.join(src_dir, fname), dest_dir)
            copied_count += 1

print(f"\nTotal matched files: {matched_count}")
print(f"Copied high-score & high-hit files (score>0.6 AND hits>8): {copied_count}")
