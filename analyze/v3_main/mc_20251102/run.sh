...
DATE="20251102"          # <-- change this for each dataset
runID="102"
...
base_root="/Volumes/ssd_zhang/thesis_michel/server_processing/t0_rootFiles/art_new20251102"

# mcTruth files
mcTruth_file="/Volumes/ssd_zhang/thesis_michel/server_processing/statScript_local/add_mcTruth_npMichel/updated_New${DATE}_initial.txt"
