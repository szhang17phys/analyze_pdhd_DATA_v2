...
# ============================================================
parser = argparse.ArgumentParser(description="Waveform merging script")
parser.add_argument("--input_dir", required=True, help="Input directory containing extracted waveform files")
parser.add_argument("--output_dir", required=True, help="Output directory for merged waveform files")
parser.add_argument("--runID", required=True, help="Run identifier string")
...
# ============================================================
#input_dir = "/Users/shuaixiangzhang/Work/current/FNAL_Work2024/michel_e/t0_tagging/pdhd_DATA_v2/t0_rootFiles/new202510_MC/event_wvf_extract_20251021/"
#output_dir = "/Users/shuaixiangzhang/Work/current/FNAL_Work2024/michel_e/t0_tagging/pdhd_DATA_v2/t0_rootFiles/new202510_MC/wvf_merged_20251021/"
#runID = "21"
...
for idx, input_file in enumerate(input_files):
    ...
    match_et = re.search(rf"mcSingleEvent_run{runID}_(event\d+_trackID\d+)\.root", basename)
    ...
    if max_groups and max_count > 1:
        ...
        for idxg, (sel_prefix, sel_hist_list) in enumerate(max_groups):
            if sel_prefix in merged_prefixes and merge_candidates:
                ...
                continue
            save_group_file(f_in, sel_hist_list, event_track_part, basename, sel_prefix, idxg)
