...
x_path = "posX_extract_202602.txt"
y_path = "posY_extract_202602.txt"
z_path = "posZ_extract_202602.txt"
S_path = "michelScore_extract_202602.txt"
H_path = "michelHits_extract_202602.txt"
...
with open(x_path, "w") as x_out, open(y_path, "w") as y_out, open(z_path, "w") as z_out, \
    ...
    #================================================================
    with open("/Volumes/ssd_zhang/thesis_michel/server_processing/statScript_local/applyCut_print/beam28891/filtered_28891new202602_print.txt", "r") as f:
        filtered_lines = f.readlines()

    #================================================================
    # Process each line in muon_total_202602.txt
    #================================================================
    with open("./muon_total_202602.txt", "r") as f:
        for line in f:
