...
# Configurations:
runFolder="beam28891BKG_new202602"  # <-- change this for each dataset          
runID="28891BKG"                    # <-- change this for each dataset

# Step 4 (if more than one print, add!)
# From server event_wvf_extract
log_files=(
    "/Volumes/ssd_zhang/thesis_michel/server_processing/statScript_local/event_wvf_extract/beam28891BKG/print_part1_BKG.log",
    "/Volumes/ssd_zhang/thesis_michel/server_processing/statScript_local/event_wvf_extract/beam28891BKG/print_part2_BKG.log",
    "/Volumes/ssd_zhang/thesis_michel/server_processing/statScript_local/event_wvf_extract/beam28891BKG/print_part3_BKG.log"
)
