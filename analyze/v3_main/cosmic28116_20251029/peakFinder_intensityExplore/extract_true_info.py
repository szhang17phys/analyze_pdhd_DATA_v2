...
x_path = "posX_extract_20251029.txt"
y_path = "posY_extract_20251029.txt"
z_path = "posZ_extract_20251029.txt"
S_path = "michelScore_extract_20251029.txt"
H_path = "michelHits_extract_20251029.txt"
...
with open(x_path, "w") as x_out, open(y_path, "w") as y_out, open(z_path, "w") as z_out, \
    ...
    #================================================================
    # Process each line in muon_total_20251029.txt
    #================================================================
    with open("./muon_total_20251029.txt", "r") as f:
        for line in f:
