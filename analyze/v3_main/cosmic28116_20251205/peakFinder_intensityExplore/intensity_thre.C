...
void processSingleFile(const char* inputFileName, const double thre_summed) {  
    ...
    std::ofstream muonFile("muon_total_20251205.txt", std::ios::app);
    std::ofstream michelFile("michel_total_20251205.txt", std::ios::app);
    std::ofstream thirdFile("third_total_20251205.txt", std::ios::app);
...
void intensity_thre() {
    ...
    std::ofstream clear1("muon_total_20251205.txt");
    std::ofstream clear2("michel_total_20251205.txt");
    std::ofstream clear3("third_total_20251205.txt");  // NEW
    clear1.close();
    clear2.close();   
    clear3.close();
