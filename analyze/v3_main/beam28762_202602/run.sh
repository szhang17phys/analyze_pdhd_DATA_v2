...
# Configurations:
runFolder="beam28762_new202602"  # <-- change this for each dataset          
runID="28762"                    # <-- change this for each dataset

# Step 4 (if more than one print, add!)
# From server event_wvf_extract
log_files=(
    "/Volumes/ssd_zhang/thesis_michel/server_processing/statScript_local/event_wvf_extract/beam${runID}/print_part1.log"    
    "/Volumes/ssd_zhang/thesis_michel/server_processing/statScript_local/event_wvf_extract/beam${runID}/print_part2.log"
    "/Volumes/ssd_zhang/thesis_michel/server_processing/statScript_local/event_wvf_extract/beam${runID}/print_part3.log"
)
